...
nnoremap <silent> <Plug>MarkSearchCascadeStartWithStop  :<C-u>call mark#StartCascade(v:count, 1)<CR>
nnoremap <silent> <Plug>MarkSearchCascadeNextWithStop   :<C-u>call mark#SearchNextCascade(v:count1, 1, 0)<CR>
nnoremap <silent> <Plug>MarkSearchCascadeStartNoStop    :<C-u>call mark#StartCascade(v:count, 0)<CR>
nnoremap <silent> <Plug>MarkSearchCascadeNextNoStop     :<C-u>call mark#SearchNextCascade(v:count1, 0, 0)<CR>
" TODO
