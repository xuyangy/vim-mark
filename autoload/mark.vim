...
function! s:NextUsedGroupIndex( isBackward, startIndex, count )
	let l:count = a:count
	for l:i in (a:isBackward ? range(a:startIndex - 1, 0, -1) + range(s:markNum - 1, a:startIndex + 1, -1) : range(a:startIndex + 1, s:markNum - 1) + range(0, a:startIndex - 1))
...
function! mark#SearchNextGroup( count, isBackward )
	...
	let l:groupIndex = s:NextUsedGroupIndex(a:isBackward, l:groupIndex, a:count)
	if l:groupIndex == -1
